package com.um.blog.repository;
...
public interface CommentRepository extends JpaRepository<Comment, Long> {
    ...
    @Query(
        value = "select distinct comment from Comment comment left join fetch comment.post",
    ...
    @Query("select distinct comment from Comment comment left join fetch comment.post")
